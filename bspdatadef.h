...
typedef  int AVL_int16;	///< 16 bits signed char data type.
typedef  unsigned int AVL_uint16;	///< 16 bits unsigned char data type.

typedef  long int AVL_int32;		///< 32 bits signed char data type.
typedef  unsigned long int AVL_uint32;	///< 32 bits unsigned char data type.
...
typedef  int * AVL_pint16;	///< pointer to a 16 bits signed char data type.
typedef  unsigned int * AVL_puint16;	///< pointer to a 16 bits unsigned char data type.

typedef  long int * AVL_pint32;	///< pointer to a 32 bits signed char data type.
typedef  unsigned long int * AVL_puint32; ///< pointer to a 32 bits unsigned char data type.
